...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 64, -1, -1, sizeof(::Protocol::CS_REQUEST_STOP)},
  { 71, -1, -1, sizeof(::Protocol::SC_BROADCAST_MOVE)},
};
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "VE\022#\n\007objects\030\001 \003(\0132\022.Protocol.MoveInfob"
  "\006proto3"
  ;
...
CS_REQUEST_MOVE::CS_REQUEST_MOVE(const CS_REQUEST_MOVE& from)
  ...
  ::memcpy(&_impl_.playerid_, &from._impl_.playerid_,
    ...
    reinterpret_cast<char*>(&_impl_.playerid_)) + sizeof(_impl_.y_));
